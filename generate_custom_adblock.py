    ...
    try:
        ...
        for line in content.splitlines():
            ...
            if len(parts) >= 2 and parts[-1].strip().lower() == "reject":
                ...
                if domain in {'mask.icloud.com', 'mask-api.icloud.com', 'mask-h2.icloud.com'}:
                    continue
...
def generate():
    ...
    with open(output_path, "w", encoding="utf-8") as f:
        ...
        if final_rules or SDK_BLOCK_RULES or final_bypass:
            f.write("[Rule]\n")
            f.write("# === LINE Notice Bar SafeFrame & Pubads PROXY Override (Top Priority) ===\n")
            f.write("DOMAIN,securepubads.g.doubleclick.net,PROXY\n")
            f.write("DOMAIN,pubads.g.doubleclick.net,PROXY\n")
